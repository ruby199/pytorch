...
"""
Contains functionality for creating PyTorch DataLpader's for image classification data.
"""
...
def create_dataloaders(
  ...
  Returns:
    ...
    Example usage:
    train_dataloader, test_dataloader, class_names = create_dataloaders(train_dir=path/to/train_dir, test_dir=path/tp/test_dir,
